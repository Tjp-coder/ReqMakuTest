package v1.testcase.post;

import v1.api.Post;
import v1.base.BaseInterface;
...
public class PostTest extends BaseTest{
    ...
    @BeforeAll
    void setUp(){
        defaultData = JsonPathUtils.jsonPathParseByFile("/v1/template/post/save.json");
        //添加5条状态为0的数据
    ...
    void readDefault() {
        id++;
        //分页数据
        defaultData = JsonPathUtils.jsonPathParseByFile("/v1/template/post/page.json");
    }
