package v1.testcase.attachment;

import v1.api.Attachment;
import v1.api.UpLoad;
...
public class PageTest extends BaseTest {
    ...
    @BeforeAll
    void setUp(){
        defaultData = JsonPathUtils.jsonPathParseByFile("/v1/template/attachment/save.json");
        //准备一些数据
    ...
    @BeforeEach
    void beforeEach(){
        defaultData = JsonPathUtils.jsonPathParseByFile("/v1/template/attachment/page.json");
    }
